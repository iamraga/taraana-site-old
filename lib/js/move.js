/*=================================================================================================================================================================================
  ==// Project Information
===================================================================================================================================================================================/*
Client      :  Move Dance Convention
Author      :  HighnessDigital
Author URI  :  http://highnessdigital.com
Year        :  March2013
...
===================================================================================================================================================================================/*
    ...
    10/- jquery.mousewheel-3.0.6.pack
	11/- jquery.fancybox
	12/- maps.googleapis
   	13/- info
   	14/- global
...
this.G;if(a.arrowSize==b)a.arrowSize=this.v;if(a.arrowStyle==b)a.arrowStyle=this.w;l(this);this.setValues(a)}window.InfoBubble=k;g=k.prototype;g.v=15;g.w=0;g.G=1;g.D=50;g.u=50;g.F=10;g.C=1;g.A="";g.B=10;g.z="";g.extend=function(a,c){return function(a){for(var c in a.prototype)this.prototype[c]=a.prototype[c];return this}.apply(a,[c])};
...
$(document).ready(function (){
	...
	if ($('#map').length > 0) {		
		...
		var map, infoBubble;
        var mapCenter = new google.maps.LatLng(43.6772539,-79.7090476);
        ...
        '<h1>November 8-9, 2014</h1>'+
        '<p class="map_title">The Garden Banquet<br> and Convention Centre </p>' +
        '<p class="map_adress">8 Clipper Crt,<br> Brampton, ON L6W 4T9 </p>' +
        '<p class="map_additional">Should you require a hotel reservation during the Convention, reservations can be made directly with the Courtyard by Marriott Toronto/Brampton, conveniently located just minutes from The Garden Banquet and Convention Centre.</p>' +
        '<p class="map_link">905-455-9000</p>' +
        '</div>';
		...
		var sidewalkView = new google.maps.LatLng(43.6772539,-79.7090476);
...
===================================================================================================================================================================================*/    	
	...
	$(document).ready(function(){
		  ...
		  $("#pin_hide").click(function(){
			   $("#menu_pin_block").slideUp(800, 'easeInOutQuart', function() {
		          $("#pin_open").show(); 
			      $("#pin_hide").hide();   
		       });
		  ...
		  $("#pin_open").click(function(){
			   $("#menu_pin_block").slideDown(800, 'easeInOutQuart', function(){
		         $("#pin_open").hide();
			     $("#pin_hide").show();
 		       });
		  });
	      ...
	      $('#fees').hide();
	      $('#fees_btn').click(function() {
	      
	        fees = $('#fees');	      
	        width = $(window).width();
	        height = $(window).height();
	      	      
	          fees.slideDown(1500, 'easeInOutQuart', function(){
	             $('body').css({ overflow: 'hidden' });
	             fees.css({ 'overflow-y': 'scroll' });
		      });
	      });
		    
		  $('#fees_close').click(function() {
		        fees = $('#fees');
		        $('body').css({ overflow: 'auto' });
		        fees.css({ 'overflow-y': 'hidden' });
		        fees.slideUp(1500, 'easeInOutQuart', function() {
		    ...
		    $('#rules_btn').click(function() {
		      ...
		      rules.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        rules.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    ...
		    $('#rules_close').click(function() {
		        rules = $('#rules');
		        $('body').css({ overflow: 'auto' });
		        rules.css({ 'overflow-y': 'hidden' });
		        rules.slideUp(1500, 'easeInOutQuart', function() {
		    ...
		    $('#crew_list_1').hide();
		    $('#crew_list_1_btn').click(function() {
		      
		      crew_list_1 = $('#crew_list_1');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_1.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_1.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_1_close').click(function() {
		        crew_list_1 = $('#crew_list_1');
		        $('body').css({ overflow: 'auto' });
		        crew_list_1.css({ 'overflow-y': 'hidden' });
		        crew_list_1.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_2').hide();
		    $('#crew_list_2_btn').click(function() {
		      
		      crew_list_2 = $('#crew_list_2');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_2.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_2.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_2_close').click(function() {
		        crew_list_2 = $('#crew_list_2');
		        $('body').css({ overflow: 'auto' });
		        crew_list_2.css({ 'overflow-y': 'hidden' });
		        crew_list_2.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_3').hide();
		    $('#crew_list_3_btn').click(function() {
		      
		      crew_list_3 = $('#crew_list_3');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_3.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_3.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_3_close').click(function() {
		        crew_list_3 = $('#crew_list_3');
		        $('body').css({ overflow: 'auto' });
		        crew_list_3.css({ 'overflow-y': 'hidden' });
		        crew_list_3.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_4').hide();
		    $('#crew_list_4_btn').click(function() {
		      
		      crew_list_4 = $('#crew_list_4');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_4.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_4.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_4_close').click(function() {
		        crew_list_4 = $('#crew_list_4');
		        $('body').css({ overflow: 'auto' });
		        crew_list_4.css({ 'overflow-y': 'hidden' });
		        crew_list_4.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_5').hide();
		    $('#crew_list_5_btn').click(function() {
		      
		      crew_list_5 = $('#crew_list_5');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_5.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_5.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_5_close').click(function() {
		        crew_list_5 = $('#crew_list_5');
		        $('body').css({ overflow: 'auto' });
		        crew_list_5.css({ 'overflow-y': 'hidden' });
		        crew_list_5.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_6').hide();
		    $('#crew_list_6_btn').click(function() {
		      
		      crew_list_6 = $('#crew_list_6');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_6.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_6.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_6_close').click(function() {
		        crew_list_6 = $('#crew_list_6');
		        $('body').css({ overflow: 'auto' });
		        crew_list_6.css({ 'overflow-y': 'hidden' });
		        crew_list_6.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_7').hide();
		    $('#crew_list_7_btn').click(function() {
		      
		      crew_list_7 = $('#crew_list_7');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_7.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_7.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_7_close').click(function() {
		        crew_list_7 = $('#crew_list_7');
		        $('body').css({ overflow: 'auto' });
		        crew_list_7.css({ 'overflow-y': 'hidden' });
		        crew_list_7.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_8').hide();
		    $('#crew_list_8_btn').click(function() {
		      
		      crew_list_8 = $('#crew_list_8');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_8.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_8.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_8_close').click(function() {
		        crew_list_8 = $('#crew_list_8');
		        $('body').css({ overflow: 'auto' });
		        crew_list_8.css({ 'overflow-y': 'hidden' });
		        crew_list_8.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_9').hide();
		    $('#crew_list_9_btn').click(function() {
		      
		      crew_list_9 = $('#crew_list_9');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_9.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_9.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_9_close').click(function() {
		        crew_list_9 = $('#crew_list_9');
		        $('body').css({ overflow: 'auto' });
		        crew_list_9.css({ 'overflow-y': 'hidden' });
		        crew_list_9.slideUp(1500, 'easeInOutQuart', function() {
		          
		        });
		    });
		    
		    $('#crew_list_10').hide();
		    $('#crew_list_10_btn').click(function() {
		      
		      crew_list_10 = $('#crew_list_10');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_10.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_10.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_10_close').click(function() {
		        crew_list_10 = $('#crew_list_10');
		        $('body').css({ overflow: 'auto' });
		        crew_list_10.css({ 'overflow-y': 'hidden' });
		        crew_list_10.slideUp(1500, 'easeInOutQuart', function() {
		     ...
		     $('#crew_list_11').hide();
		     $('#crew_list_11_btn').click(function() {
		      
		      crew_list_11 = $('#crew_list_11');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_11.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_11.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_11_close').click(function() {
		        crew_list_11 = $('#crew_list_11');
		        $('body').css({ overflow: 'auto' });
		        crew_list_11.css({ 'overflow-y': 'hidden' });
		        crew_list_11.slideUp(1500, 'easeInOutQuart', function() {
		    ...
		    $('#crew_list_12').hide();
		     $('#crew_list_12_btn').click(function() {
		      
		      crew_list_12 = $('#crew_list_12');
		      
		      // Window size
		      width = $(window).width();
		      height = $(window).height();
		      		      
		      crew_list_12.slideDown(1500, 'easeInOutQuart', function(){
		        $('body').css({ overflow: 'hidden' });
		        crew_list_12.css({ 'overflow-y': 'scroll' });
 		      });
		    });
		    
		    $('#crew_list_12_close').click(function() {
		        crew_list_12 = $('#crew_list_12');
		        $('body').css({ overflow: 'auto' });
		        crew_list_12.css({ 'overflow-y': 'hidden' });
		        crew_list_12.slideUp(1500, 'easeInOutQuart', function() {
